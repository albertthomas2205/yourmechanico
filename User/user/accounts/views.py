...
from .serializer import UserRegisterSerializer,MyTokenObtainPairSerializer, BlockUserSerializer,UserlistSerializer, OtpRequestSerializer,OtpResponseSerializer
...
def block_user(request):
    ...
    if serializer.is_valid():
        ...
        try:
            ...
            user.is_active = False  # Set is_active to False to block the user
            user.save()
